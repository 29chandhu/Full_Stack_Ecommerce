  ...
  return (
    <div className="productdisplay">
      ...
      <div className="productdisplay-right">
        ...
        <p className="productdisplay-right-category"><span>Category :</span> Top Hardware components</p>
        <p className="productdisplay-right-category"><span>Tags :</span> Best, Latest</p>
      </div>
    </div>
  );
};
